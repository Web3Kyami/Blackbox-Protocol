...
const NEW_ARENA_CLASS = "0x6dac5b7ca4e958c05b44c9b690f3c870deac60e819848bf555ebd65219d35de"; // P1-fixed Arena
...
const evidence = {
    network: "sepolia",
    test: "honest round v5 (adapter-mediated execution + P1-fixed arena class)",
...
async function runMain() {
    ...
    evidence.final_state = {
        ...
        value_observation: "portfolio values submitted via adapter contract-context; delivery PULLED by adapter (transfer_from), custody per-pool recorded on-chain",
    ...
    console.log(`
════════════════════════════════════════
  HONEST ROUND v5 — ADAPTER-MEDIATED EXECUTION
